# A simple React app that allows a user to enter their name, phone, and email with some frontend validation (including regex for email). First using useState hook and later using useReducer hook.
